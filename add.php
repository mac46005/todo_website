        ...
        <main>
            <div class="content-container">
                <form action="./script/addItem.php">
                    ...
                    <input class="rdBtn" type="radio" name="importanceLevel" id="importanceLevel2" onclick="chkImportance();"><label for="level2">medium</label>
                    <input class="rdBtn" type="radio" name="importanceLevel" id="importanceLevel3" onclick="chkImportance();"><label for="level3">high</label>
                    <br>
